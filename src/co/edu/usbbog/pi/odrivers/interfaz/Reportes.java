...
public class Reportes extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        if (jTable1.getColumnModel().getColumnCount() > 0) {
            jTable1.getColumnModel().getColumn(0).setHeaderValue("N° Reporte");
            jTable1.getColumnModel().getColumn(1).setHeaderValue("Titulo reporte");
            jTable1.getColumnModel().getColumn(2).setHeaderValue("Descripción");
            jTable1.getColumnModel().getColumn(3).setHeaderValue("Opciones");
        }
