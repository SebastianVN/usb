...
public class InicioDeSesionPanel extends javax.swing.JPanel {
     ...
     * @param principal 
     */
    public InicioDeSesionPanel(Principal principal) {
    ...
    private void ingresar() {
        if (validar()) {
            if (principal.existeUsuario(jTextFieldUsuario.getText())) {
                String password = new String(jPasswordFieldClave.getPassword());
                if (principal.verificarClaveUsuario(jTextFieldUsuario.getText(), password)) {
                    limpiar();
