...
import co.edu.usbbog.is.paciente.modelo.HistorialMedico;
...
public class HistorialMedicoJpaController implements Serializable {
    ...
    public void create(HistorialMedico historialMedico) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findHistorialMedico(historialMedico.getCodigoHis()) != null) {
                throw new PreexistingEntityException("HistorialMedico " + historialMedico + " already exists.", ex);
            }
            throw ex;
        } finally {
            if (em != null) {
    ...
    public void edit(HistorialMedico historialMedico) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (msg == null || msg.length() == 0) {
                Integer id = historialMedico.getCodigoHis();
